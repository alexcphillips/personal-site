      ...
      <div id="page">
        <div id="main-container">
          ...
          <p className="body-text">
            ...
            and I began coding with my father at a young age. I enjoy solving
            new challenges and growing as a developer. I put in the time to my
            craft to overcome obstacles and exceed all expectations.
          </p>
          <h6 id="heading">My Favorite Projects</h6>
          <p className="body-text">
            My current project is an Excel file processing application I built
            in microservices. The microservices included Express REST APIs and
