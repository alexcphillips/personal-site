        ...
        <div className="page">
            ...
            <div className="main-container">
                <div className="inner-container">
                    ...
                    {/* <div style={{ marginBottom: "1rem" }} /> */}I started
                    work as a Node.js Developer at ANI Consulting in 2019. I
                    build microservices, REST APIs, and love learning new
                    things.
                    ...
                    <div className="section">
                        ...
                        <div className="role left">
                            NODEJS DEVELOPER - ANI CONSULTING • 09/2019 -
                            CURRENT
                        </div>
                        <ul className="left">
                            <li>Built REST APIs with Express server</li>
                            <li>
                                Converted Excel file data to JSON for MongoDB
                                storage
                            </li>
                            <li>Used Redis pub sub for microservices</li>
                            <li>Containerized applications with Docker</li>
                            <li>
                                Created unit tests with Jest for 100% coverage
                            </li>
                            <li>
                                Deploy Docker containers to ec2s on AWS with
                                docker-compose
                            </li>
                            <li>Managed security groups for ec2 instances</li>
                            <li>
                                Created scripts to automatically open and shut
                                down ec2s as needed for development
                            </li>
                            <li>
                                Built financial reporting and Excel data
                                processing applications including frontend React
                                components
                            </li>
                        </ul>
